...
const Hero = () => {
  return (
    <section className="relative h-[500px] bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1589829545856-d10d557cf95f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80')" }}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative h-full flex flex-col justify-center">
        ...
        >
          <h1 className="text-white font-playfair text-3xl md:text-5xl font-bold mb-4">The Body of Senior Advocates of Nigeria</h1>
